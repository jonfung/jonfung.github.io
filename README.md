...
Anyway, i'm working on an intent presettlement protocol called tplus (tplux.cx) - basically trying to actually push financial markets forward by using crypto rails and decoupling confirmations from withdrawals
